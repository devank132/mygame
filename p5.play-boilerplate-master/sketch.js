...
function preload() {
  ...
  coronai=loadImage("images/corona.jpg")
  vaccinei=loadImage("images/vaccine.png")
  scientisti=loadImage("images/scientist.jpg")
  runningboyi=loadImage("images/runningboy.jpg")
...
wall28=createSprite(350,430,150,20)
  ...
  corona.bounce(wall3)
  corona.bounce(wall4)
  corona1.bounce(wall1) 
  corona1.bounce(wall2)
  corona1.bounce(wall3)
  corona1.bounce(wall4)
}
